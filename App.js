    ...
    return (
      ...
      >
        ...
        {showMore && (
          ...
          >
            <RowViewDark label={"Current Timezone"} value="Europe/London" />
            <RowViewDark label={"Day of the year"} value="295" />
            <RowViewDark label={"Day of the week"} value="5" />
            <RowViewDark label={"Week number"} value="42" />
          </View>
        )}
      </ImageBackground>
    );
